...
const ContactUs = () => {
  ...
  const address = 'Tadbhan, Bahadur Pura, Opp Nishat Hotel, Hyderabad, Telangana 500064, India';
  const directionsLink = 'https://www.google.com/maps/dir//Misri+Gym/data=!4m8!4m7!1m0!1m5!1m1!1s0x3bcb977d66679285:0x76dd778ad9e78fad!2m2!1d78.4511722!2d17.3456239'; // Replace with your own directions link
  const businessHours = [
  ...
  return (
    <section id='contactus' className="bg-black py-20 md:py-18 lg:pt-140 lg:pb-180">
      <div className="container mx-auto px-1bb0 lg:px-135">
        {/* Section title */}
        <div
          className="section-title-group max-w-540 mx-auto px-4 lg:px-0"
          data-aos="fade-up"
          data-aos-delay="200"
        >
